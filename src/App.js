    ...
    return (
        <BrowserRouter>
            <Routes className='App'>
                ...
                />
                <Route exact path='/shop_app/products/:category' element={<ProductsPage />} />
                <Route
                    exact
                    restricted
                ...
                />
                <Route exact path='/shop_app/products/:category/:_id' element={<ItemPage />} />
                <Route exact path='/shop_app/statute' element={<StatutePage />} />
